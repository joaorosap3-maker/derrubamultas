    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="mt-20">
        ...
        <section className="relative min-h-[800px] flex items-center bg-inverse-surface text-surface overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-8 w-full grid lg:grid-cols-12 gap-16 relative z-10 py-24">
            <motion.div 
              ...
              <div className="flex gap-4 items-center">
                <div className="flex -space-x-4">
                  {[
                    ...
                    <div key={i} className="w-12 h-12 rounded-full border-2 border-inverse-surface bg-surface-container-highest overflow-hidden">
                      <img src={src} alt="Expert" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                    </div>
                  ))}
                </div>
                <p className="text-sm font-semibold tracking-wide text-surface-container-highest">
            ...
            >
              <div className="bg-surface-container-lowest p-10 rounded-xl shadow-2xl text-inverse-surface">
                <h3 className="text-2xl font-bold mb-8 tracking-tight">Consulta Gratuita</h3>
                <form className="space-y-6" onSubmit={handleFormSubmit}>
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent border-b-2 border-outline-variant/20 focus:border-primary-fixed focus:ring-0 px-0 py-2 transition-all outline-none" 
        ...
        <section className="py-32 bg-surface" id="processo">
          <div className="max-w-7xl mx-auto px-8">
            <div className="mb-20">
              <h2 className="text-4xl font-extrabold tracking-tight mb-4">
                Serviços <span className="text-primary-fixed bg-inverse-surface px-2">Especializados</span>
              </h2>
              <p className="text-on-surface-variant max-w-2xl text-lg">Soluções jurídicas e administrativas completas para manter sua regularidade no trânsito.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <motion.div 
                whileHover={{ y: -5 }}
                className="md:col-span-2 bg-surface-container-low p-12 rounded-xl flex flex-col justify-between border-l-4 border-primary-fixed"
              >
                <div>
                  <Gavel className="w-12 h-12 text-primary-fixed-dim mb-6" />
                  <h3 className="text-3xl font-bold mb-4">Recurso de Multas</h3>
                  <p className="text-on-surface-variant max-w-md leading-relaxed">Defesa técnica contra infrações indevidas em até 3 instâncias administrativas (Defesa Prévia, JARI e CETRAN). Atuamos desde a análise inicial até a última fase do processo, identificando erros formais e fundamentos legais para aumentar suas chances de sucesso.</p>
                </div>
                <div 
                  onClick={() => setIsModalOpen(true)}
                  className="mt-12 flex items-center text-inverse-surface font-bold gap-2 cursor-pointer group"
                >
                  Saber mais <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
                </div>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-inverse-surface text-surface p-12 rounded-xl"
              >
                <IdCard className="w-12 h-12 text-primary-fixed mb-6" />
                <h3 className="text-2xl font-bold mb-4">Suspensão CNH</h3>
                <p className="text-outline-variant leading-relaxed">Evite a perda definitiva do seu direito de dirigir por excesso de pontos ou bafômetro.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-surface-container-highest p-12 rounded-xl"
              >
                <Search className="w-12 h-12 text-inverse-surface mb-6" />
                <h3 className="text-2xl font-bold mb-4">Indicação de Condutor</h3>
                <p className="text-on-surface-variant leading-relaxed">Assessoria para transferência correta de pontuação fora do prazo regulamentar.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-surface-container-low p-12 rounded-xl"
              >
                <FileText className="w-12 h-12 text-inverse-surface mb-6" />
                <h3 className="text-2xl font-bold mb-4">Assessoria Administrativa</h3>
                <p className="text-on-surface-variant leading-relaxed">Gestão completa de processos e documentos junto ao DETRAN.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-primary-fixed p-12 rounded-xl text-on-primary-fixed"
              >
                <ShieldCheck className="w-12 h-12 mb-6" />
                <h3 className="text-2xl font-bold mb-4">Certificado Digital</h3>
                <p className="text-on-primary-fixed leading-relaxed">Emissão de e-CPF e e-CNPJ para facilitar seus trâmites digitais.</p>
              </motion.div>
            </div>
          </div>
        </section>
        ...
        {/* Benefits Section */}
        <section className="py-32 bg-surface-container-lowest" id="vantagens">
          <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-3 gap-16">
            <div className="space-y-6">
              <div className="w-16 h-1 bg-primary-fixed"></div>
              <Zap className="w-12 h-12 text-primary-fixed-dim" />
              <h3 className="text-2xl font-bold">Atendimento Rápido</h3>
              <p className="text-on-surface-variant leading-relaxed">Sabemos que multas têm prazos fatais. Nossa equipe responde sua primeira consulta em minutos para não perder tempo.</p>
            </div>
            <div className="space-y-6">
              <div className="w-16 h-1 bg-primary-fixed"></div>
              <GraduationCap className="w-12 h-12 text-primary-fixed-dim" />
              <h3 className="text-2xl font-bold">Especialistas</h3>
              <p className="text-on-surface-variant leading-relaxed">Diferente de escritórios genéricos, somos focados exclusivamente em Direito de Trânsito com alta taxa de sucesso.</p>
            </div>
            <div className="space-y-6">
              <div className="w-16 h-1 bg-primary-fixed"></div>
              <Eye className="w-12 h-12 text-primary-fixed-dim" />
              <h3 className="text-2xl font-bold">Transparência</h3>
              <p className="text-on-surface-variant leading-relaxed">Acompanhe cada etapa do seu processo com clareza. Sem falsas promessas, apenas resultados reais baseados na lei.</p>
            </div>
          </div>
        </section>

        {/* Testimonials */}
        <section className="py-32 bg-surface" id="depoimentos">
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-20">
              <h2 className="text-4xl font-extrabold tracking-tight mb-4">O Veredito de Quem Confia</h2>
              <p className="text-on-surface-variant">Veja como ajudamos condutores a manterem sua liberdade.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="evidence-card">
                <p className="italic text-lg text-inverse-surface mb-8 leading-relaxed">"Tive minha CNH suspensa por uma multa injusta de bafômetro. A equipe da DerrubaMultas conseguiu anular o processo em tempo recorde!"</p>
              ...
              <div className="evidence-card">
                <p className="italic text-lg text-inverse-surface mb-8 leading-relaxed">"Excelente assessoria. Resolveram o problema de pontuação acumulada que eu nem sabia como lidar. Atendimento muito humano e profissional."</p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-outline-variant rounded-full overflow-hidden">
                  ...
                  <div>
                    <h4 className="font-bold">Carla Menezes</h4>
                    <p className="text-xs text-on-surface-variant font-bold uppercase tracking-tighter">Advogada</p>
                  </div>
                </div>
              </div>
              <div className="evidence-card">
                <p className="italic text-lg text-inverse-surface mb-8 leading-relaxed">"Preço justo e muita competência. Recuperei meu direito de dirigir e não perdi meu emprego de motorista. Recomendo para todos!"</p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-outline-variant rounded-full overflow-hidden">
        ...
        <section className="py-32 bg-surface-container-low" id="faq">
          <div className="max-w-3xl mx-auto px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-extrabold tracking-tight mb-4">Perguntas Frequentes</h2>
              <p className="text-on-surface-variant">Tire suas dúvidas sobre o processo de recurso.</p>
            </div>
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span className="text-lg font-bold text-inverse-surface">{faq.question}</span>
                    <motion.div
        ...
        <section className="bg-inverse-surface py-24 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="max-w-2xl text-center md:text-left">
              <h2 className="text-4xl md:text-5xl font-black text-surface mb-6 tracking-tighter leading-tight">Não perca sua CNH. <br/>Fale conosco agora.</h2>
              <p className="text-outline-variant text-xl">A análise inicial é 100% gratuita e sem compromisso.</p>
            </div>
